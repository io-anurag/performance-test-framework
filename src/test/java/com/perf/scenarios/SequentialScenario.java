...
public class SequentialScenario {
    ...
    public static void apply(TestContext context, BasePerformanceTest test, String domain) {
        ...
        HTTPSamplerProxy home = test.createHttpSampler("Home Page", domain, "/html", "GET");
        ...
        HTTPSamplerProxy login = test.createHttpSampler("Login Page (Fake)", domain, "/status/200", "GET");
